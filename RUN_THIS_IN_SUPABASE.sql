...
BEGIN
  RETURN QUERY
  SELECT
    o.id, o.order_number, o.client_id, o.status, o.rush, o.due_date, o.notes,
    o.created_at, o.updated_at, o.is_archived, o.estimated_completion_date,
    o.actual_completion_date, o.total_cents, o.is_active,
    ...
    COALESCE(JSON_AGG(JSON_BUILD_OBJECT(
      ...
      'services', COALESCE(
        (SELECT JSON_AGG(JSON_BUILD_OBJECT(
          ...
          'service', (SELECT JSON_BUILD_OBJECT(
            'id', s.id,
            'name', s.name,
            'category', s.category,
            'price', s.base_price_cents
          ) FROM service s WHERE s.id = gs.service_id)
        )) FROM garment_service gs WHERE gs.garment_id = g.id),
        '[]'::json
      )
    )), '[]'::json) AS garments,
  ...
  GROUP BY o.id, o.order_number, o.client_id, o.status, o.rush, o.due_date,
