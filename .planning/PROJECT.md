...
**P1 - Architecture (Must complete first):**
- [ ] MOD-001: Task assignment at ITEM level (not order level)
- [ ] MOD-002: Price management at ITEM level (editable final price)

**P2 - User Interface:**
- [ ] MOD-003: Merge "Select Garment" + "Select Service" steps
- [ ] MOD-004: Reduce vertical space by 40%
- [ ] MOD-005: Add list view toggle (service selection)
- [ ] MOD-006: Replace item codes with product names
- [ ] MOD-007: Manage Task button per item + auto-close
- [ ] MOD-008: Add phone field to client page

**P3 - Export Features:**
- [ ] MOD-009: Export project list per seamstress (CSV)
- [ ] MOD-010: Export orders list (CSV)
- [ ] MOD-011: Export weekly capacity (CSV)
- [ ] MOD-012: Team member management (add/remove)

**P4 - Removal:**
- [ ] MOD-013: Remove timer/stopwatch completely (replace with manual input)

**P5 - Responsive Design:**
- [ ] MOD-014: Full iPhone responsive support
- [ ] MOD-015: Optimize iPad portrait mode

**P6 - Calendar:**
- [ ] MOD-016: Fix order timeline calendar scrolling
- [ ] MOD-017: Add "Unassigned Orders" category
