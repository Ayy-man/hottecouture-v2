...
CREATE INDEX IF NOT EXISTS idx_garment_service_garment
ON garment_service (garment_id);

CREATE INDEX IF NOT EXISTS idx_garment_service_service
...
CREATE INDEX IF NOT EXISTS idx_task_garment_stage
ON task (garment_id, stage);

-- Active tasks by stage (task uses 'stage' column, not 'status')
CREATE INDEX IF NOT EXISTS idx_task_stage_active
...
CREATE INDEX IF NOT EXISTS idx_client_phone_name
ON client (phone, last_name, first_name);

-- Search by name and email
CREATE INDEX IF NOT EXISTS idx_client_search
ON client (last_name, first_name, email);

-- Full-text search for client names
CREATE INDEX IF NOT EXISTS idx_client_fulltext
...
CREATE INDEX IF NOT EXISTS idx_time_tracking_order
ON time_tracking (order_id, created_at DESC);

-- Time tracking by garment
CREATE INDEX IF NOT EXISTS idx_time_tracking_garment
ON time_tracking (garment_id, is_tracking);

-- Active time tracking sessions
CREATE INDEX IF NOT EXISTS idx_time_tracking_active
...
CREATE INDEX IF NOT EXISTS idx_service_display_order
