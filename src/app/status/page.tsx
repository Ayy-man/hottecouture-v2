            ...
            <form onSubmit={handleSearch} className='space-y-4'>
              ...
              <div className='flex gap-3'>
                <Button
                  type='submit'
                  disabled={loading}
                  className='flex-1 sm:flex-none btn-press bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed'
                >
                  {loading ? (
                    <>
          ...
          <div className='space-y-6'>
            {orders.length > 0 && (
              <div className='text-center mb-6'>
                <h2 className='text-2xl font-semibold bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent mb-2'>
                ...
                <CardContent className='p-6'>
                  ...
                  <div className='mt-6 pt-4 border-t border-gray-200'>
                    <div className='flex flex-col sm:flex-row gap-3'>
                      <Button
                        asChild
                        className='flex-1 btn-press bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300'
                      >
