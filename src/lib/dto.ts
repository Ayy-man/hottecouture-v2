...
export const clientCreateSchema = z.object({
  ...
  phone: phoneSchema.optional(), // Landline is now optional
  mobile_phone: phoneSchema, // Mobile/SMS number is now required
  email: emailSchema, // Required for GHL contact sync
  language: z.enum(['fr', 'en']).default('fr'),
  preferred_contact: z.enum(['email', 'sms', 'phone']).default('sms'), // Added 'phone' option
